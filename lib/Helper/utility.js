...
// Importăm modulele interne ale bibliotecii
...
const isValidJid = (jid) => {
    // Use internal WABinary utilities
    return Utils_1.isJidUser(jid) || Utils_1.isJidGroup(jid) || jid.endsWith('@broadcast');
};
...
const phoneNumberToJid = (phoneNumber) => {
    ...
    return Utils_1.jidNormalizedUser(`${number}@s.whatsapp.net`);
};
